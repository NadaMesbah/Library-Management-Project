...
class Emprunt(models.Model):
    id_emp = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    #emprunteur = models.ForeignKey(Adherant, on_delete=models.CASCADE, verbose_name='Emprunteur', related_name='emprunteur_emprunts')
    exemplaire = models.ForeignKey(Exemplaire, on_delete=models.CASCADE, verbose_name='Exemplaire', related_name='exemplaire_emprunts')
